...
var update = __webpack_require__(145)("3e0d111d", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-01e7f602\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Login.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-01e7f602\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Login.vue");
...
// module
exports.push([module.i, "\n.formDiv[data-v-01e7f602] {\n  margin: 0 auto;\n  text-align: center;\n  width: 100%;\n  top: 30%;\n  position: absolute;\n}\n.loginForm[data-v-01e7f602] {\n  width: 300px;\n  float: right;\n  margin-right: 150px;\n}\n.loginBtn[data-v-01e7f602] {\n  width: 100%;\n}\n", ""]);
  ...
  data: function data() {
    return {
      ...
      ruleInline: {
        ...
        password: [{ required: true, message: '请填写密码', trigger: 'blur' }, { type: 'string', min: 5, message: '密码长度不能小于5位', trigger: 'blur' }]
      }
    };
  },
      ...
      this.$refs[name].validate(function (valid) {
        if (valid) {
          if (sessionStorage.getItem("loginStatus") == "true") {
            ...
            _this.$http.post('/login', _this.formInline).then(function (response) {
              // 请求成功
              if (response.data != '') {
                // 登录成功 并将用户信息修改
                _this.$store.commit('loginSuccess', response.data);
                if (_this.$store.state.loginUserInfo.role == '0') {
